...
public class PlayerChoices {
	...
	ShopMenu menu = new ShopMenu();
	 void tavernMenu() {
		...
		System.out.println("Shop - Dungeon - Rest(10 GP) - Stats");
	 }
	...
	void tavernChoice(Entities player) {
		...
		System.out.println("Shopkeep: Ah an adventurer, welcome to my shop what can I getcha?");
		menu.generateItemList();
		...
		case "Rest":
			...
			tavernChoice(player);
				...
				System.out.println("Tavern Owner: Ah sorry mate, looks like you ain't got the coin for a room. Come back later when you do.");
				tavernMenu();
				tavernChoice(player);
			}
		break;
